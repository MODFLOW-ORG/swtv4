C--SEAWAT: NOTE, CHANGES WERE MADE TO SOME SUBROUTINES IN THIS FILE
C--SEAWAT: SO THAT BINARY OUTPUT IS WRITTEN AS SINGLE PRECISION.
...
C--SEAWAT: CHANGED TO WRITE SINGLE PRECISION
...
C1------INFORMATION.
C--SEAWAT: MODIFIED TO WRITE SINGLE PRECISION
      WRITE(ICHN) KSTP,KPER,REAL(PERTIM,4),REAL(TOTIM,4),TEXT,NCOL,
     &            NROW,ILAY
C
...
C4C-----LOCAT<0; READ UNFORMATTED ARRAY VALUES.
  ...
  203    FORMAT(1X,///1X,A,' FOR CROSS SECTION',/
     1    1X,'READING BINARY ON UNIT ',I4)
      END IF
C--SEAWAT:  READ AS SINGLE PRECISION REAL
...
C1------WRITE TWO UNFORMATTED RECORDS IDENTIFYING DATA.
    ...
    1 FORMAT(1X,'UBDSV1 SAVING "',A16,'" ON UNIT',I4,
     1     ' AT TIME STEP',I3,', STRESS PERIOD',I4)
      WRITE(IBDCHN) KSTP,KPER,TEXT,NCOL,NROW,-NLAY
C--SEAWAT: MODIFED TO WRITE SINGLE PRECISION
      WRITE(IBDCHN) 1,REAL(DELT,4),REAL(PERTIM,4),REAL(TOTIM,4)
C
C2------WRITE AN UNFORMATTED RECORD CONTAINING VALUES FOR
C2------EACH CELL IN THE GRID.
C--SEAWAT: MODIFED TO WRITE SINGLE PRECISION
...
C1------WRITE THREE UNFORMATTED RECORDS IDENTIFYING DATA.
    ...
    1 FORMAT(1X,'UBDSV2 SAVING "',A16,'" ON UNIT',I4,
     1     ' AT TIME STEP',I3,', STRESS PERIOD',I4)
      WRITE(IBDCHN) KSTP,KPER,TEXT,NCOL,NROW,-NLAY
C--SEAWAT: MODIFIED TO WRITE SINGLE PRECISION
      WRITE(IBDCHN) 2,REAL(DELT,4),REAL(PERTIM,4),REAL(TOTIM,4)
      WRITE(IBDCHN) NLIST
C
C2------RETURN
      RETURN
...
C--SEAWAT: MODIFED TO WRITE SINGLE PRECISION
      WRITE(IBDCHN) IMETH,REAL(DELT,4),REAL(PERTIM,4),REAL(TOTIM,4)
C
...
C2A-----FOR LAYER 1.
C--SEAWAT: MODIFED TO WRITE SINGLE PRECISION
         WRITE(IBDCHN) ((REAL(BUFF(J,I,1),4),J=1,NCOL),I=1,NROW)
      ELSE
...
C--SEAWAT: MODIFED TO WRITE SINGLE PRECISION
         WRITE(IBDCHN) ((REAL(BUFF(J,I,IBUFF(J,I)),4),J=1,NCOL),
     &                   I=1,NROW)
      END IF
C
C3------RETURN
...
C1------WRITE UNFORMATTED RECORDS IDENTIFYING DATA.
    ...
    1 FORMAT(1X,'UBDSV4 SAVING "',A16,'" ON UNIT',I4,
     1     ' AT TIME STEP',I3,', STRESS PERIOD',I4)
      WRITE(IBDCHN) KSTP,KPER,TEXT,NCOL,NROW,-NLAY
C--SEAWAT: MODIFED TO WRITE SINGLE PRECISION
      WRITE(IBDCHN) 5,REAL(DELT,4),REAL(PERTIM,4),REAL(TOTIM,4)
      WRITE(IBDCHN) NAUX+1
...
C2------WRITE CELL NUMBER AND FLOW RATE
      IF(NAUX.GT.0) THEN
         N2=LAUX+NAUX-1
C--SEAWAT: MODIFED TO WRITE SINGLE PRECISION
         WRITE(IBDCHN) ICRL,REAL(Q,4),(REAL(VAL(N),4),N=LAUX,N2)
      ELSE
C--SEAWAT: MODIFED TO WRITE SINGLE PRECISION
         WRITE(IBDCHN) ICRL,REAL(Q,4)
      END IF
