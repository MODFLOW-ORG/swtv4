C
      SUBROUTINE IMT1TOB5AL(INTOB,IOUT,ISUM,ISUM2,NCOL,NROW,NLAY,
...
C
C
      SUBROUTINE IMT1TOB5RP(INTOB,IOUT,NCOL,NROW,NLAY,NCOMP,MaxConcObs,
...
C      
      if(x.lt.0. .or. x.gt.1.) then
        call ustop('Bad argument x in subroutine BETAI used by TOB Packa
     &ge')
      endif  
...
C     
      ...
      enddo      
      call ustop('a or b too big, or MAXIT too small in subroutine BETAC
     &F used by TOB Package')
    1 betacf=h
C
      RETURN
      END
